...
public enum CommonErrorCode {
    ...
    WEEK_CONFIG_PREVIOUS_SEMESTER_NOT_GENERATED(1059, "Phải sinh cấu hình tuần cho học kỳ trước trước"),
    PROGRAM_DISTRIBUTION_INVALID_FILE(1060, "File Excel không hợp lệ"),
    PROGRAM_DISTRIBUTION_TEMPLATE_DATA_NOT_FOUND(1061, "Không đủ dữ liệu để tạo mẫu phân phối chương trình"),
    PROGRAM_DISTRIBUTION_CLASSROOM_SCHOOL_YEAR_MISMATCH(1062, "Lớp không thuộc năm học đã chọn"),
    PROGRAM_DISTRIBUTION_SUBJECT_NOT_ASSIGNED_TO_CLASSROOM(1063, "Môn học chưa được cấu hình cho lớp này"),
