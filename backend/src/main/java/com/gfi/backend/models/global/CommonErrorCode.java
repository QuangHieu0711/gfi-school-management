...
public enum CommonErrorCode {
    ...
    SCHOOL_YEAR_NAME_ALREADY_EXISTS(1011, "ên năm học đã tồn tại"),
    SCHOOL_YEAR_NOT_FOUND(1012, "Không tìm thấy năm học"),
    SCHOOL_YEAR_IN_USE(1013, "ăm học đang được sử dụng, không thể xóa"),
    ...
    GRADE_LEVEL_NAME_ALREADY_EXISTS(1020, "ên khối đã tồn tại"),
    ...
    CLASS_NAME_ALREADY_EXISTS(1025, "ên lớp đã tồn tại trong đơn vị, khối và năm học"),
    CLASS_NOT_FOUND(1026, "Không tìm thấy lớp"),
    SUBJECT_CODE_ALREADY_EXISTS(1027, "Mã môn học đã tồn tại"),
    SUBJECT_NAME_ALREADY_EXISTS(1028, "ên môn học đã tồn tại"),
    SUBJECT_NOT_FOUND(1029, "Không tìm thấy môn học"),
    SUBJECT_IN_USE(1030, "ôn học đang được cấu hình, không thể xóa"),
    STUDENT_CODE_ALREADY_EXISTS(1031, "Mã học sinh đã tồn tại"),
    STUDENT_NOT_FOUND(1032, "Không tìm thấy học sinh"),
    STUDENT_ENROLLMENT_SCHOOL_YEAR_MISMATCH(1033, "ớp không thuộc năm học đã chọn"),
    STUDENT_ENROLLMENT_UNIT_MISMATCH(1034, "ớp không thuộc đơn vị của học sinh"),
