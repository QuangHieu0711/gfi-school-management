...
public enum CommonErrorCode {
    ...
    ROLE_IN_USE(1006, "Vai trò đang được gán, không thể xóa"),
    ...
    SUBJECT_IN_USE(1030, "Môn học đang được cấu hình, không thể xóa"),
    ...
    MENU_CODE_ALREADY_EXISTS(1039, "Mã menu đã tồn tại"),
    MENU_NOT_FOUND(1040, "Không tìm thấy menu"),
    MENU_IN_USE(1041, "Menu đang được gán permission, không thể xóa"),
    ...
    STAFF_CODE_ALREADY_EXISTS(1049, "Mã cán bộ đã tồn tại"),
    STAFF_NOT_FOUND(1050, "Không tìm thấy cán bộ"),
    WEEK_CONFIG_NOT_FOUND(1051, "Không tìm thấy cấu hình tuần"),
    WEEK_CONFIG_ALREADY_EXISTS_FOR_SEMESTER(1052, "Học kỳ đã có cấu hình tuần"),
    WEEK_CONFIG_WEEK_NUMBER_ALREADY_EXISTS(1053, "Số tuần đã tồn tại trong học kỳ"),
    WEEK_CONFIG_START_DATE_INVALID(1054, "Ngày bắt đầu tuần không được trước ngày bắt đầu học kỳ"),
    WEEK_CONFIG_END_DATE_INVALID(1055, "Ngày kết thúc tuần không được sau ngày kết thúc học kỳ"),
    WEEK_CONFIG_DATE_OVERLAP(1056, "Thời gian tuần trùng lặp với tuần khác trong học kỳ"),
    WEEK_CONFIG_SEMESTER_SCHOOL_YEAR_MISMATCH(1057, "Học kỳ không thuộc năm học đã chọn"),
    WEEK_CONFIG_BULK_DUPLICATE_ID(1058, "Danh sách cập nhật có id bị trùng"),
